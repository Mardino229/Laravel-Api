...
@section('content')
    <form action="{{route("auth.login")}}" method="POST" class="max-w-sm mx-auto border mt-16 sm:mt-32 rounded-lg">
        @csrf
        ...
        <div class="p-6">
            ...
            <a href="{{route("auth.signup")}}" class="text-indigo-400">or signup</a>
        </div>
    </form>
@endsection
